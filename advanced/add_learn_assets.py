#!/usr/bin/env python3
"""Idempotently wire the learning-experience layer into every ADVANCED page.

Mirrors the root add_learn_assets.py but uses /advanced/ asset paths and the
advanced nav. Run from inside the advanced/ folder.
...
for path in pages:
    ...
    if "/advanced/learn.js" not in html:
