...
(function () {
    ...
    var K_PROGRESS = 'tagalog-adv-progress';   // { "1": {completed, visited, ts}, ... }
    var K_KNOWN    = 'tagalog-adv-known';      // legacy flat map { "salamat": ts, ... } — migrated into SRS
    var K_SRS      = 'tagalog-adv-srs';        // { "salamat": {box,due,reps}, ... }
    var K_JOURNAL  = 'tagalog-adv-journal:';   // + page slug

    // Advanced course: derive the lesson count from the vocab titles map so
